...
public class SapphireBoltEntityRenderer extends EntityRenderer<SapphireBoltEntity> {
    ...
    private final StaffProjectileEntityModel<SapphireBoltEntity> model;

    public SapphireBoltEntityRenderer(EntityRendererFactory.Context context) {
        super(context);
        this.model = new StaffProjectileEntityModel(context.getPart(TerrariaClientMod.MODEL_RUBY_BOLT_LAYER));
    }

    public void render(SapphireBoltEntity staffProjectileEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        matrixStack.push();
    ...
    public Identifier getTexture(SapphireBoltEntity staffProjectileEntity) {
        return TEXTURE;
    }
}
