...
import net.andychen.terrariamod.entity.projectile.RubyBoltEntity;
...
public class RubyBoltEntityRenderer extends EntityRenderer<RubyBoltEntity> {
    ...
    private final StaffProjectileEntityModel<RubyBoltEntity> model;

    public RubyBoltEntityRenderer(EntityRendererFactory.Context context) {
        super(context);
        this.model = new StaffProjectileEntityModel(context.getPart(TerrariaClientMod.MODEL_RUBY_BOLT_LAYER));
    }

    public void render(RubyBoltEntity staffProjectileEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        matrixStack.push();
    ...
    public Identifier getTexture(RubyBoltEntity staffProjectileEntity) {
        return TEXTURE;
    }
}
