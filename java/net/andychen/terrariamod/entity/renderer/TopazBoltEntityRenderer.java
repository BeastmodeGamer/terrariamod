...
public class TopazBoltEntityRenderer extends EntityRenderer<TopazBoltEntity> {
    ...
    private final StaffProjectileEntityModel<TopazBoltEntity> model;

    public TopazBoltEntityRenderer(EntityRendererFactory.Context context) {
        super(context);
        this.model = new StaffProjectileEntityModel(context.getPart(TerrariaClientMod.MODEL_TOPAZ_BOLT_LAYER));
    }

    public void render(TopazBoltEntity staffProjectileEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        matrixStack.push();
    ...
    public Identifier getTexture(TopazBoltEntity staffProjectileEntity) {
        return TEXTURE;
    }
}
