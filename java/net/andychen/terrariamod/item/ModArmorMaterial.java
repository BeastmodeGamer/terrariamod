...
public enum ModArmorMaterial implements ArmorMaterial {
    ...
    DEMONITE("demonite", 20, new int[]{2, 6, 7, 3}, 11, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 1.0F, 0.0F, () -> {
        return Ingredient.ofItems(new ItemConvertible[]{ModItems.DEMONITE_INGOT});
    }),
    CRIMSON("crimson", 20, new int[]{2, 6, 7, 3}, 11, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 1.0F, 0.0F, () -> {
        return Ingredient.ofItems(new ItemConvertible[]{ModItems.CRIMTANE_INGOT});
    }),
    HELLSTONE("hellstone", 35, new int[]{3, 6, 8, 3}, 8, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 3.0F, 0.0F, () -> {
        return Ingredient.ofItems(new ItemConvertible[]{ModItems.HELLSTONE_INGOT});
    });
